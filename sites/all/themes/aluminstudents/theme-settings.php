 ...
 *   The form state.
 */
function aluminstudents_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['aluminstudents_width'] = array(
    '#type' => 'radios',
    ...
    '#default_value' => theme_get_setting('aluminstudents_width'),
